...
<table style="border:none; margin-bottom:2px;">
    <tr>
        ...
        <td style="border:none; vertical-align:middle;">
            <div class="doc-title">PROPERTY RETURN SLIP</div>
        </td>
    </tr>
</table>
...
<table style="margin-bottom:0;">
    <tr>
        <td colspan="7" style="font-size:9pt; padding:4px 6px; text-align:center; font-style:italic;">
            This slip certifies that PPE currently issued to the accountable officer is being returned before disposal processing.
        </td>
    </tr>
</table>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width:14%">Property No.<br>/PAR Number</th>
            <th style="width:11%">Amount</th>
            <th style="width:16%">Accountable Officer</th>
...
<div class="instructions">
    ...
    <p><em>Use this form for items with a value of PHP 50,000 and above.</em></p>
</div>
