...
<div class="min-h-screen bg-gray-100">
    ...
    <div class="bg-[#1a2c5b] border-b-4 border-[#c8a84b] shadow-lg">
        <div class="w-full px-4 sm:px-6 lg:px-8 py-4">
            ...
            <p class="text-white font-bold text-lg leading-tight mt-0.5">Add Signatory</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('signatories.store') }}" class="p-5 space-y-4">
                ...
                <div>
                    ...
                    <select name="role_key" required class="w-full rounded border border-gray-300 text-sm px-3 py-2">
                        ...
                        <option value="{{ $key }}" {{ old('role_key') === $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. JUAN D. DELA CRUZ"
                ...
                <div>
                    ...
                    <input type="text" name="designation" value="{{ old('designation') }}" required placeholder="e.g. Provincial Governor"
                ...
                <div>
                    ...
                    <input type="text" name="entity_name" value="{{ old('entity_name', 'Provincial Government of Surigao Del Norte') }}" required
                           class="w-full rounded border border-gray-300 text-sm px-3 py-2">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit" class="rounded bg-[#1a2c5b] px-6 py-2 text-sm font-semibold text-white hover:bg-[#253d82] transition">Save Signatory</button>
