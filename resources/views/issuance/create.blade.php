...
function issuanceForm() {
    return {
        lines: [{ item_id: '', inventory_item_id: '', quantity: 1, unit: '', description: '', property_no: '', date_acquired: '', unit_cost: 0, estimated_useful_life: '', remarks: '' }],

        addLine() {
            this.lines.push({ item_id: '', inventory_item_id: '', quantity: 1, unit: '', description: '', property_no: '', date_acquired: '', unit_cost: 0, estimated_useful_life: '', remarks: '' });
        },
