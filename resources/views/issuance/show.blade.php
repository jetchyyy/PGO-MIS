            ...
            <div class="lg:col-span-1 space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded shadow-sm overflow-hidden">
                    ...
                    <div class="p-3 flex flex-col gap-2">
                        <a href="{{ route('issuance.print', [$issuance, 'sticker']) }}" target="_blank"
                           class="flex items-center gap-2 rounded border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700 hover:bg-emerald-100 transition">
                            <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            Property Sticker / Tag
                        </a>
                        @if($issuance->document_type === 'PAR')
                        <a href="{{ route('issuance.print', [$issuance, 'par']) }}" target="_blank"
                           class="flex items-center gap-2 rounded border border-gray-200 px-3 py-2 text-xs font-semibold text-[#1a2c5b] hover:bg-gray-50 transition">
                            <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
