    ...
    <div class="bg-white border-b border-gray-200 shadow-sm">
        ...
        <div class="w-full px-4 pb-3 sm:px-6 lg:px-8">
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('transfer.index', array_filter(['doc' => $tabKey !== 'all' ? $tabKey : null])) }}"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                @forelse($transfers as $i => $row)
                    @php
                        $primaryDocument = $row->documentControls->firstWhere('template_name', strtolower($row->document_type));
                    @endphp
