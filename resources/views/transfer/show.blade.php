...
<div class="min-h-screen bg-gray-100" x-data="@js([
    ...
    <div class="w-full px-4 pt-5 pb-8 sm:px-6 lg:px-8">
        @if(in_array($transfer->status, ['approved', 'issued']))
        <div class="mb-4">
            @include('partials.document-tabs', ['documents' => $generatedDocuments, 'record' => $transfer, 'routeName' => 'transfer.print'])
        </div>
        @endif
                        ...
                        <table class="min-w-full text-sm">
                            ...
                            <tfoot class="border-t-2 border-gray-300 bg-gray-50">
                                <tr>
                                    ...
                                    <td class="px-5 py-3 text-right font-extrabold text-[#1a2c5b]">PHP {{ number_format($transfer->lines->sum('amount'), 2) }}</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
